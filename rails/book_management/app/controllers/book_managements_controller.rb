class BookManagementsController < ApplicationController
  ...
  private
    ...
    def book_management_params
      params.require(:book_management).permit(:student_id_265, :full_name_265, :class_265, :book_id_265, :book_name_265, :book_author_265, :book_category_265, :bm_number_265, :borrow_date_265, :back_date_265, :number_date_265)
    end
end
